...
public class ItemEyePlunder extends ItemFU {
    ...
    public ItemEyePlunder() {
        ...
        this.setUnlocalizedName(RefName.Items.eyePlunder);
    }

    @Override
    @SideOnly(Side.CLIENT)
    public void registerIcons(IIconRegister IIconRegister) {
        itemIcon = IIconRegister.registerIcon(RefInfo.RESOURCE_PREFIX + "eyePlunder_0");
        filledIcon = IIconRegister.registerIcon(RefInfo.RESOURCE_PREFIX + "eyePlunder_1ani");
    }
