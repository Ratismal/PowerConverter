...
import io.github.ratismal.powerconverter.base.blocks.BaseBlock;
import io.github.ratismal.powerconverter.reference.Names;
import io.github.ratismal.powerconverter.tab.CreativeTabPC;
import io.github.ratismal.powerconverter.base.tiles.BaseStorageTile;
...
public class BlockTestRFMachine extends BaseBlock {
    ...
    public BlockTestRFMachine() {
        ...
        super();
        this.setBlockName(Names.testMachineRF);
